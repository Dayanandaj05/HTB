...
def create_defaced_grade_image():
    ...
    # Save with EXIF data
    image.save('../artifacts/defaced_grade.jpg', 'jpeg', exif=exif_bytes)
    
    print("✓ Artifact Alpha created: ../artifacts/defaced_grade.jpg")
    ...
    return '../artifacts/defaced_grade.jpg'


def verify_exif():
    """Verify the EXIF data was written correctly"""
    try:
        exif_dict = piexif.load('../artifacts/defaced_grade.jpg')
